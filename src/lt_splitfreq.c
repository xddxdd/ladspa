...
ON_LOAD_ROUTINE {
    ...
    if(ladspa_plugin_info) {
        ...
        LADSPA_PortRangeHint* ladspa_port_range_hint = (LADSPA_PortRangeHint*) calloc(PORT_COUNT, sizeof(LADSPA_PortRangeHint));
...
ON_UNLOAD_ROUTINE {
    deleteDescriptor(ladspa_plugin_info);
}
